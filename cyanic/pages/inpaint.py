...
class InpaintPage(QWidget):
    def __init__(self, settings_controller:SettingsController, api:SDAPI):
        ...
        self.generate_widget = GenerateWidget(self.settings_controller, self.api, [self.mask_widget, self.color_correction, self.denoise_widget, self.model_widget, self.prompt_widget, self.batch_widget, self.seed_widget, self.extension_widget], 'inpaint', self.size_dict)
