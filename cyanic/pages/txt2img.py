...
from ..widgets import PromptWidget, SeedWidget, CollapsibleWidget, ModelsWidget, GenerateWidget
...
class Txt2ImgPage(QWidget):
    def __init__(self, settings_controller:SettingsController, api:SDAPI):
        ...
        self.generate_widget = GenerateWidget(self.settings_controller, self.api, [self.model_widget, self.prompt_widget, self.seed_widget], 'txt2img')
