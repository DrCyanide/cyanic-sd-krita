...
from ..widgets import PromptWidget, SeedWidget, CollapsibleWidget, ModelsWidget, GenerateWidget, ImageInWidget, DenoiseWidget
...
class Img2ImgPage(QWidget):
    def __init__(self, settings_controller:SettingsController, api:SDAPI):
        ...
        self.generate_widget = GenerateWidget(self.settings_controller, self.api, [self.img_in, self.denoise_widget, self.model_widget, self.prompt_widget, self.seed_widget], 'img2img')
